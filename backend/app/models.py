...
class AssessmentSession(Base):
    ...
    data_restrictions_ack: Mapped[bool] = mapped_column(default=False, nullable=False)
    ai_consent_version: Mapped[str] = mapped_column(String(64), default="2026-03-privacy-guard-v1", nullable=False)
    ai_consented_at: Mapped[datetime] = mapped_column(DateTime, default=_utc_now, nullable=False)
